...
export default function TestLightningPage() {
  const mockPaymentData: LightningInvoiceData = {
    ...
    description: "Invoice Crypto use via whatsapp",
    desc_hash: false,
    created_at: 1753788126,
    status: "unpaid",
    amount: 165,
    callback_url: "https://server.cryptouse.com.br/webhook/opennode",
    success_url: null,
    ...
    uri: "bitcoin:39sPshRJezPmnww3EWPm7MNhdCWDmeJphU?amount=0.00000165&label=Invoice+Crypto+use+via+whatsapp&lightning=",
    ttl: 10,
    lightning_invoice: {
