...
export function StepThree({ amount, bitcoinAmount, goToPrevStep, copyToClipboard }: StepThreeProps) {
  const pixCode = "00020126330014BR.GOV.BCB.PIX0111036491024680213Compra Bitcoin5204000053039865802BR5924João Silva6009SAO PAULO62120508Hodle1234630454C8";
  
  return (
    <div className="w-full">
      <h2 className="text-2xl font-bold text-center mb-6">Realize o pagamento</h2>
      <div className="bg-white p-6 rounded-xl shadow-sm border-2 border-orange-300">
        ...
        <div className="flex flex-col items-center mb-6">
          ...
          <div className="w-full py-3 px-4 bg-gray-50 rounded-lg flex items-center justify-between mb-4">
            <div className="truncate max-w-xs">
              <div className="text-xs text-gray-500 mb-1">Chave PIX (copia e cola)</div>
        ...
        <div className="flex justify-between">
          <Button variant="outline" onClick={goToPrevStep} className="border-gray-200">
