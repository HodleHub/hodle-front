...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'provedor de ativos virtuais',
    'crypto asset service provider',
    'virtual asset service provider',
    'licença cripto Brasil',
    'licença VASP Brasil',
    'licença PSAV Brasil',
    ...
    'BACEN cripto',
    'marco regulatório cripto',
    'marco legal cripto Brasil',
    'criptoativo regulado',
    'ativo virtual regulado',
    'empresa regulada cripto',
    'exchange regulada Brasil',
    'plataforma regulada cripto',
    'compliance BACEN',
    'compliance Banco Central',
    'regulação stablecoin Brasil',
    'regulação USDT Brasil',
    'regulação USDC Brasil',
    'PSD2 cripto',
    'LAV cripto',
    'lei lavagem dinheiro cripto',
    'prevenção lavagem cripto',
    'due diligence cripto',
    'relatório transações suspeitas cripto',
    'RCT cripto',
    'comunicação transação cripto',
  ],
...
const organizationJsonLd = {
  ...
  regulatoryStatus: 'VASP (Virtual Asset Service Provider) - Regulated by Banco Central do Brasil (BACEN)',
  knowsAbout: [
    'Virtual Asset Service Provider',
    'PSAV',
    'Stablecoin payments',
