  ...
  sections: [
    {
      ...
      body: 'Pagar Pix com USDT é liquidar uma cobrança em reais usando dólar digital como fonte de fundos. Você não precisa vender a stablecoin antes, nem passar o valor por uma conta bancária: o saldo em USDT financia o pagamento e a liquidação em reais acontece no mesmo fluxo.\n\nPara quem recebe, nada muda. O Pix entra em reais, com o mesmo comprovante de sempre. A ponte entre a stablecoin e o sistema de pagamentos brasileiro fica do lado da Hodle.',
      bullets: [
    ...
    },
    {
      ...
      body: 'No painel, o pagamento é um formulário. Na integração, é uma chamada. O mesmo endpoint que a Hodle usa internamente é o que você consome, autenticado por API key com escopo por plataforma.\n\nO gas das redes EVM é patrocinado: você não precisa manter saldo nativo de Polygon ou Base para conseguir pagar.',
      bullets: [
